how can I create one control node and multiple worker node of different os, instance type and names by terraform for ansible and what is map function in terraform file.
